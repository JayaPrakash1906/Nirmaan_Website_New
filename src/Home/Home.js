...
import { FaBusinessTime,FaChevronLeft,FaChevronRight,FaUserGroup} from "react-icons/fa6";
        ...
        {stats.map((stat) => (
          ...
          >
            <div className="text-3xl font-semibold text-green-700">
              <CountUp end={stat.value} suffix={stat.label === "Total Valuation" || stat.label === "Revenue Generated By Startups" ? ' Cr+' : '+'} />
