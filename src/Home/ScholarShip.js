    ...
    <div>
      ...
      <div className="mt-[88px] font-dmsans">
                <div className="md:bg-green-100">
                        ...
                        <h2 className="md:text-5xl font-semibold text-gray-500 pt-20 text-center sm:text-3xl">Scholarship</h2>
                        <div className="text-center pt-2 pb-3">offered</div>
                </div>
                <div className="mt-10">
                           <div className="grid md:grid-cols-2 gap-24 mx-24">
                                    <div className="border pt-2 pb-4 mb-2 border-t-2 border-green-300">
                                                <h2 className="text-center text-3xl font-semibold text-gray-500 mt-4 mb-4">UGFIR</h2>
                                    ...
                                    <div className="border pt-2 pb-2 mb-2 border-t-2 border-green-300">
                                                <h2 className="text-center text-3xl font-semibold text-gray-500 mt-4 mb-4">KGMG</h2>
