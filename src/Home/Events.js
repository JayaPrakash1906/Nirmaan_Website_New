        ...
        <div>
            ...
            <div className="mt-[88px] font-dmsans">
                 <div className="md:bg-green-100">
                        ...
                        <h2 className="md:text-5xl font-semibold text-green-600  text-center pb-3 pt-8 sm:text-3xl">Upcoming Events</h2>
                        {/* <div className="text-center pt-3 pb-3"> Nirmaan </div> */}
                </div>
                <div className="grid md:grid-cols-2 px-10 mt-10 gap-14">
                        <div className="flex justify-end items-center"><img src={demo} className="md:h-[350px] md:shadow-lg border "/></div>
                        <div className="">
