        ...
        <div>
            ...
            <div className="mt-[88px] font-dmsans">
                <div className="bg-green-100">
                        ...
                        <h2 className="text-5xl font-semibold text-gray-500 pt-16 text-center">News Room</h2>
                        <div className="text-center pt-2 pb-3"> Nirmaan Spotlight</div>
                </div>
                ...
                <div className="mt-7">
                        <div className="text-3xl text-center ">Highlights</div>
                        <div className="grid grid-cols-3 px-10 mt-5 gap-10 my-10">
                                    <div className="border rounded-md pb-2">
                                        <div className="flex justify-center items-center">
                                                <img src={img} className="max-h-40 h-70 w-50 rounded-full my-5 mx-10"/>
                                        </div>
                                    ...
                                    <div className="border rounded-md pb-2">
                                        <div className="flex justify-center items-center">
                                                <img src={img1} className="max-h-40 h-70 w-50 rounded-full my-5 mx-10"/>
                                        </div>
                                    ...
                                    <div className="border rounded-md pb-2">
                                        <div className="flex justify-center items-center">
                                                <img src={img2} className="max-h-40 h-70 w-50 rounded-full my-5 mx-10"/>
                                        </div>
